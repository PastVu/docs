...
5. Правила оформления названий изображений
   ...
   9. Названия типа: "Мой двор", "Я возле моего дома" неприемлемы. Также неприемлемы вульгарные названия местностей, типа: "Пятачок", "На бродвее", "Шанхай"  и т.п. Подобные "народные" названия, при желании, следует приводить в поле описания.
